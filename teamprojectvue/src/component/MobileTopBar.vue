<template>
  ...
  <!-- 토글 사이드바 -->
  <div
    class="fixed w-[360px] h-[545px] bg-slate-950 opacity-70 z-40 transform transition-transform duration-300 ease-in-out"
    v-show="!isSideBar"
    @click="toggleSideBar"
  ></div>
  <div
  v-show="!isSideBar"
    class=" fixed bg-white w-52 h-[545px] z-50 transform transition-transform duration-300 ease-in-out"
