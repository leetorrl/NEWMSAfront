    ...
    <br>
      <div>
        ...
        <div>
          ...
          <textarea id="message" v-model="content" rows="5"
        ...
        <div class="flex justify-end">
          ...
          <button @click="QnAboardsave()" type="button" class="flex justify-end p-2 pl-5 pr-5 text-white bg-blue-600 border-2 rounded-lg hover:opacity-85">
            제출
          </button>
        </div>
      </div>
...
<script setup>
import { stgetuserapi, stQnAboardsaveapi } from '@/api/student';
import { ref } from 'vue';
